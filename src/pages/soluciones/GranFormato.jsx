...
const GranFormato = () => {
    ...
    const features = [
        ...
        {
            icon: Layers,
            title: "Geometrías a Escala Real",
            desc: "Materializamos tus modelos en su tamaño definitivo. Solución enfocada en prototipos, maquetas o piezas donde el volumen es el requerimiento principal."
        },
        {
            icon: ShieldCheck,
            title: "Estabilidad Estructural",
            desc: "Ingeniería aplicada a piezas de gran volumen. Optimizamos la distribución de material para que la pieza soporte su propio peso y mantenga su integridad."
        }
    ];
    ...
    const steps = [
        ...
        { id: "04", t: "FINALIZACIÓN TÉCNICA", d: "Retiro de estructuras de soporte y verificación dimensional. La pieza se entrega limpia y lista para su uso o montaje." }
    ];
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            <Helmet>
                ...
                <meta name="description" content="Impresión 3D de gran tamaño. Piezas de hasta 50cm en una sola construcción. Geometrías a escala real con estabilidad estructural garantizada." />
            </Helmet>
            ...
            <main className="flex-grow">
                            ...
                            {features.map((f, i) => (
                                ...
                                >
                                    ...
                                    <div className="relative z-10 p-8 flex flex-col h-full">
                                        <div className="w-12 h-12 rounded-xl bg-teal-500/20 flex items-center justify-center mb-6 text-teal-500 group-hover:scale-110 transition-transform duration-300">
                                            <f.icon size={24} />
                                        </div>
                                        {/* Accent Line */}
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            <div className="lg:w-1/2">
                                <SectionTitle
                                    ...
                                    className="mb-8"
                                />
                                <p className="text-gray-600 text-lg mb-8 leading-relaxed border-l-4 border-teal-500 pl-6">
                            ...
                            <div className="lg:w-1/2 relative">
                                <div className="aspect-video bg-secondary-dark rounded-3xl overflow-hidden shadow-2xl relative group flex items-center justify-center">
                                    <Cuboid size={80} className="text-white/20" />
                                    <div className="absolute inset-0 bg-gradient-to-tr from-teal-500/20 to-transparent pointer-events-none"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {/* Proceso de Fabricación XL */}
                <section className="py-24 bg-gray-50">
                    <div className="container mx-auto px-6 whatsapp-safe-zone">
                        <div className="text-center mb-16">
                            <span className="text-primary font-bold tracking-widest uppercase text-sm">Metodología</span>
                            <h2 className="text-3xl md:text-5xl font-bold text-secondary-dark mt-2">Proceso de Fabricación XL</h2>
                        </div>
                ...
                <section className="py-24 bg-white border-t border-gray-100">
                    <div className="container mx-auto px-6 whatsapp-safe-zone">
                        <div className="bg-secondary-dark rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
                            ...
                            <div className="relative z-10">
                                <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">¿Pensando en grande?</h2>
